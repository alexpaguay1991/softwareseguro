package com.ecovida.usuarios.seguridad;



import com.ecovida.usuarios.entidades.Roles;
import com.ecovida.usuarios.repositorio.UserRepositorio;
...
public class CustomUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String usernameOrEmail) throws UsernameNotFoundException {
		...
		com.ecovida.usuarios.entidades.User user = userRepositorio.findByUsernameOrEmail(usernameOrEmail, usernameOrEmail)
				.orElseThrow(() -> new UsernameNotFoundException("Usuario no encontrado con ese username o email : " + usernameOrEmail));
