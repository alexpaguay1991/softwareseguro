package com.ecovida.catalogoproductos.controlador;


import com.ecovida.catalogoproductos.dto.ProductDTO;
import com.ecovida.catalogoproductos.servicio.ProductServicio;
...
public class ProductControlador {
    ...
    public ResponseEntity<ProductDTO> guardarProducto(@Valid @PathVariable(value = "categoriaId") long categoriaId, @Valid @RequestBody ProductDTO productDTO){
